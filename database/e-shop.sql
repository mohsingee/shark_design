...
(1, 'M. Zeeshan', 'About price', 'zeeshanmuhammad94@gmail.com', NULL, '9807009999', 'Hello sir i am from kathmandu nepal.', '2020-08-14 08:25:46', '2020-08-14 08:00:01', '2020-08-14 08:25:46'),
(2, 'M. Zeeshan', 'About Price', 'zeeshanmuhammad94@gmail.com', NULL, '9800099000', 'Hello i am M. Zeeshan', '2020-08-18 03:04:15', '2020-08-15 07:52:39', '2020-08-18 03:04:16'),
(3, 'M. Zeeshan', 'lorem ipsum', 'zeeshanmuhammad94@gmail.com', NULL, '1200990009', 'hello sir sdfdfd dfdjf ;dfjd fd ldkfd', NULL, '2020-08-17 21:15:12', '2020-08-17 21:15:12');
...
(1, 'ORD-PMIQF5MYPK', 3, 14399.00, 1, 573.90, 13925.10, 6, 'cod', 'unpaid', 'delivered', 'Prajwal', 'Rai', 'zeeshanmuhammad94@gmail.com', '9800887778', 'NP', '44600', 'Koteshwor', 'Kathmandu', '2020-08-14 07:20:44', '2020-08-14 09:37:37'),
...
(3, 'ORD-1CKWRWTTIK', 3, 200.00, 1, NULL, 300.00, 1, 'paypal', 'paid', 'process', 'Prajwal', 'Rai', 'zeeshanmuhammad94@gmail.com', '9807009999', 'NP', '44600', 'Kathmandu', 'Kadaghari', '2020-08-15 06:40:49', '2020-08-17 20:52:40'),
(4, 'ORD-HVO0KX0YHW', 3, 23660.00, 3, 150.00, 23910.00, 6, 'paypal', 'paid', 'new', 'Prajwal', 'Rai', 'zeeshanmuhammad94@gmail.com', '9800098878', 'NP', '44600', 'Pokhara', NULL, '2020-08-15 07:54:52', '2020-08-15 07:54:52');
...
(1, 'Our Vision is to make interior brands accessible to everyone. With this in the forefront of our mind, we can ensure our customers that we have the best, the exclusives and most popular wallpaper designs available. The result is a collection of all the top wallpaper brands, from coveted designer names to emerging new creations.

With dozens of new collections added each week, there will always be something to suit everyones style. The luxury about shopping with us, is that everything is all under one roof for you to select what wallpaper, flooring, curtains, bedding and we send it all directly to you at the click of a button.', 'Our passion stems from creating the perfect home for our customers. Our company started from humble beginnings in 2018 where from a small selection of designs and styles to branching out from wallpaper to then include paint, ceiling roses and not forgetting flooring..', '/storage/photos/1/logo.png', '/storage/photos/1/blog3.jpg', 'Maa'le Iron - Musmus', '+972502445194', 'info@sharkdesign.co.il', NULL, '2020-08-14 01:49:09');
...
(1, 'M. Zeeshan', 'admin@gmail.com', NULL, '$2y$10$GOGIJdzJydYJ5nAZ42iZNO3IL1fdvXoSPdUOH3Ajy5hRmi0xBmTzm', '/storage/photos/1/users/user1.jpg', 'admin', NULL, NULL, 'active', 'j3HsNG66YHyVUW5Y8JEiLq3OT3zcg2RHpodDxujcIKtAu0IKaLUX7Tf1h54g', NULL, '2020-08-15 06:47:13'),
...
(3, 'M. Zeeshan', 'zeeshanmuhammad94@gmail.com', NULL, '$2y$10$15ZVMgH040v4Ukf9KSAFiucPJcfDwmeRKCaguVJBXplTs93m48F1G', '/storage/photos/1/users/user3.jpg', 'user', NULL, NULL, 'active', NULL, '2020-08-11 04:20:58', '2020-08-15 07:56:58'),
...
(29, 'M. Zeeshan', 'rae.prajwal@gmail.com', NULL, NULL, NULL, 'user', 'google', '110717103019405487938', 'active', NULL, '2020-08-15 07:36:29', '2020-08-15 07:36:29');
