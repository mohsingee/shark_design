...
class CategoryController extends Controller
{
    ...
    {
        //$parent_cats=Category::where('is_parent',1)->where('parent_id',null)->orderBy('title','ASC')->get();
        $category = new Category();
        $parent_cats = $category->getAllParentWithChild();
    ...
    public function destroy($id)
    {
        ...
        if($status){
            ...
            request()->session()->flash('success','Category successfully inactive');
        }
        else{
    ...
    public function getChildSubByParent(Request $request){
        // return $request->all();
        $category=Category::findOrFail($request->id);
        $child_cat=Category::getChildByParentID($request->id);
        // return $child_cat;
