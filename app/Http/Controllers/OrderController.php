...
class OrderController extends Controller
{
    ...
    {
        $order = Order::find($id);
        $order_products = Cart::where(['order_id' => $id])->get();
        // return $order;
        return view('backend.order.show_new', compact('order','order_products'));
    ...
    public function update(Request $request, $id)
    {
        ...
        if($request->status=='delivered'){
            foreach($order->cart as $cart){
                ...
                // return $product;
                $product->quantity_in_stock -=$cart->quantity;
                $product->save();
            }
        }
    ...
    public function pdf(Request $request){
        ...
        //dd($order);
        $pdf = PDF::loadView('backend.order.pdf_new', compact('order'));
        //dd($order);
        //dd($pdf->output());//ahmed
