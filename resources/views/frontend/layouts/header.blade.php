<style>
    ...
    li.child-dropdown1 ul.dropdown{
        display: none;
    }
    li.child-dropdown1:hover ul.dropdown{
        display: block;
    }
</style>
                ...
                <div class="col-lg-2 col-md-2 col-12">
                    ...
                    <div class="logo">
                        @php
                            $settings=DB::table('settings')->get();
                        @endphp
                        <a href="{{route('home')}}"><img src="{{asset($settings[0]->logo)}}" alt="logo"></a>
                    </div>
                    <!--/ End Logo -->
                    <!-- Search Form -->
                                        ...
                                        @if (count(Helper::getAllProductFromWishlist()) > 0)
                                            @foreach(Helper::getAllProductFromWishlist() as $data)
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="#"><img src="{{$photo_img}}" alt="{{$photo_img}}"></a>
                                            ...
                                            @foreach(Helper::getAllProductFromCart() as $data)
                                                    ...
                                                    <li>
                                                        ...
                                                        <a class="cart-img" href="#">
                                                            <img src="{{$photo_img}}" alt="{{$data->title}}">
                                                        </a>
                                                        <h4><a href="{{route('product-detail',$data->product['slug'])}}" target="_blank">{{$data->product['title']}}</a></h4>
                                                        <p class="quantity">{{$data->quantity}} x - <span class="amount">${{number_format($data->price,2)}}</span></p>
                                                    </li>
