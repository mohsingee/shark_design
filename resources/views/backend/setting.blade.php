...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
            <label for="copyrights" class="col-form-label">Copyrights</label>
            <input type="text" class="form-control" name="copyrights"  value="{{$data->copyrights}}">
        </div>
        <div class="form-group">
          <label for="tax" class="col-form-label">Tax</label>
          <input type="number" min="1" class="form-control" name="tax" value="{{$data->tax}}">
        </div>
